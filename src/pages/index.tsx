  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of project execution with Construction Tool Rental, your one-stop solution for renting tools from a central supplier with multiple outlets"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of project execution with Construction Tool Rental, your one-stop solution for renting tools from a central supplier with multiple outlets`}
            </Text>
            <Box
