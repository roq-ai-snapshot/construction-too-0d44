...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345 has been placed by a customer.create': {
    roles: [
      'owner',
      'logistics-manager',
      'admin',
  ...
  'Product XYZ is running low on stock.update': {
    roles: ['owner', 'logistics-manager', 'admin', 'business-owner', 'store-manager'],
    key: 'inventory_update',
    tenantPath: [],
    userPath: [],
  },
  'A customer has raised a query regarding their order.create': {
    roles: ['owner', 'admin', 'business-owner', 'customer-service-representative'],
    key: 'customer_query',
    tenantPath: [],
    userPath: [],
  },
